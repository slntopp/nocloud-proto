...
class State extends \Google\Protobuf\Internal\Message
{
    ...
    private $meta;
    /**
     * Generated from protobuf field <code>repeated .nocloud.states.Interface interfaces = 4 [json_name = "interfaces"];</code>
     */
    private $interfaces;
    /**
     ...
     *           Driver(Provider/Hypervisor) State data
     *     @type array<\Nocloud\States\PBInterface>|\Google\Protobuf\Internal\RepeatedField $interfaces
     *     @type int|string $ts
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .nocloud.states.Interface interfaces = 4 [json_name = "interfaces"];</code>
     * @param array<\Nocloud\States\PBInterface>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setInterfaces($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Nocloud\States\PBInterface::class);
        $this->interfaces = $arr;
