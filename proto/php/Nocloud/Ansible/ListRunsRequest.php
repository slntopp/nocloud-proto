...
class ListRunsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $sort = null;
    /**
     * Generated from protobuf field <code>optional string uuid = 5 [json_name = "uuid"];</code>
     */
    protected $uuid = null;
    /**
     * Generated from protobuf field <code>map<string, .google.protobuf.Value> filters = 6 [json_name = "filters"];</code>
     */
    private $filters;
