...
class EdgeServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Nocloud\Edge\ConfigData $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function PostConfigData(\Nocloud\Edge\ConfigData $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nocloud.edge.EdgeService/PostConfigData',
        $argument,
        ['\Nocloud\Edge\PBEmpty', 'decode'],
        $metadata, $options);
    }
