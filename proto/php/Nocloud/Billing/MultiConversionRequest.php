...
/**
 * Generated from protobuf message <code>nocloud.billing.MultiConversionRequest</code>
 */
class MultiConversionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $to = null;
    /**
     * Generated from protobuf field <code>repeated double amounts = 3 [json_name = "amounts"];</code>
     */
    private $amounts;
