...
class PromocodesServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Nocloud\Billing\ApplySaleRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ApplySale(\Nocloud\Billing\ApplySaleRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nocloud.billing.PromocodesService/ApplySale',
        $argument,
        ['\Nocloud\Billing\ApplySaleResponse', 'decode'],
        $metadata, $options);
    }
