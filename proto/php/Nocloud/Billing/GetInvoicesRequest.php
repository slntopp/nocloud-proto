...
/**
 * Generated from protobuf message <code>nocloud.billing.GetInvoicesRequest</code>
 */
class GetInvoicesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $uuid = null;
    /**
     * Generated from protobuf field <code>optional .nocloud.billing.BillingStatus status = 8 [json_name = "status"];</code>
     */
    protected $status = null;
    /**
     * Generated from protobuf field <code>map<string, .google.protobuf.Value> filters = 9 [json_name = "filters"];</code>
     */
    private $filters;
