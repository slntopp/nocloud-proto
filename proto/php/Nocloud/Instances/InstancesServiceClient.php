...
class InstancesServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Nocloud\Instances\StartRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function Start(\Nocloud\Instances\StartRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nocloud.instances.InstancesService/Start',
        $argument,
        ['\Nocloud\Instances\StartResponse', 'decode'],
        $metadata, $options);
    }
