 ...
 * @const
 */
proto.nocloud.billing.Transaction.repeatedFields_ = [7];
...
proto.nocloud.billing.Transaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    recordsList: (f = jspb.Message.getRepeatedField(msg, 7)) == null ? undefined : f,
    total: jspb.Message.getFloatingPointFieldWithDefault(msg, 8, 0.0),
    metaMap: (f = msg.getMetaMap()) ? f.toObject(includeInstance, proto.google.protobuf.Value.toObject) : []
  };
...
proto.nocloud.billing.Record.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resource: jspb.Message.getFieldWithDefault(msg, 8, ""),
    product: jspb.Message.getFieldWithDefault(msg, 9, ""),
...
/**
 * optional nocloud.states.NoCloudState state = 7;
 * @return {!proto.nocloud.states.NoCloudState}
 */
proto.nocloud.billing.Record.prototype.getState = function() {
  return /** @type {!proto.nocloud.states.NoCloudState} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
