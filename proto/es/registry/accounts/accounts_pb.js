 ...
 */
export const AccountMeta = /*@__PURE__*/ proto3.makeMessageType(
  "nocloud.registry.accounts.AccountMeta",
  () => [
    { no: 1, name: "notifications", kind: "message", T: Notifications },
  ],
);
 ...
 */
export const Notifications = /*@__PURE__*/ proto3.makeMessageType(
  "nocloud.registry.accounts.Notifications",
  () => [
    { no: 1, name: "first_balance_notify", kind: "message", T: BalanceNotification },
    { no: 2, name: "second_balance_notify", kind: "message", T: BalanceNotification },
  ],
);
 ...
 */
export const BalanceNotification = /*@__PURE__*/ proto3.makeMessageType(
