 ...
 */
export const PlanKind = proto3.makeEnum(
 ...
 */
export const Round = proto3.makeEnum(
 ...
 */
export const PeriodKind = proto3.makeEnum(
 ...
 */
export const ListPlansInstancesRequest = proto3.makeMessageType(
 ...
 */
export const ListPlansInstancesResponse = proto3.makeMessageType(
 ...
 */
export const ResourceConf = proto3.makeMessageType(
...
export const Invoice = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "account", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "transactions", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 8, name: "total", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 9, name: "meta", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "message", T: Value} },
    { no: 10, name: "currency", kind: "message", T: Currency },
    { no: 11, name: "created", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 12, name: "items", kind: "message", T: Item, repeated: true },
    { no: 13, name: "type", kind: "enum", T: proto3.getEnumType(ActionType) },
  ],
);
 ...
 */
export const Transactions = proto3.makeMessageType(
 ...
 */
export const Records = proto3.makeMessageType(
 ...
 */
export const GetActiveRequest = proto3.makeMessageType(
 ...
 */
export const GetTransactionsRequest = proto3.makeMessageType(
 ...
 */
export const ReprocessTransactionsRequest = proto3.makeMessageType(
 ...
 */
export const GetTransactionsCountRequest = proto3.makeMessageType(
 ...
 */
export const GetTransactionsCountResponse = proto3.makeMessageType(
 ...
 */
export const UpdateTransactionRequest = proto3.makeMessageType(
 ...
 */
export const UpdateTransactionResponse = proto3.makeMessageType(
 ...
 */
export const CostEstimation = proto3.makeMessageType(
 ...
 */
export const GetInstancesReportRequest = proto3.makeMessageType(
 ...
 */
export const InstanceReport = proto3.makeMessageType(
 ...
 */
export const GetInstancesReportResponse = proto3.makeMessageType(
 ...
 */
export const GetRecordsReportsRequest = proto3.makeMessageType(
 ...
 */
export const GetRecordsReportsResponse = proto3.makeMessageType(
 ...
 */
export const GetInstancesReportsCountRequest = proto3.makeMessageType(
 ...
 */
export const GetRecordsReportsCountRequest = proto3.makeMessageType(
 ...
 */
export const GetReportsCountResponse = proto3.makeMessageType(
 ...
 */
export const CreateExchangeRateResponse = proto3.makeMessageType(
 ...
 */
export const UpdateExchangeRateResponse = proto3.makeMessageType(
 ...
 */
export const DeleteExchangeRateResponse = proto3.makeMessageType(
 ...
 */
export const GetCurrenciesRequest = proto3.makeMessageType(
 ...
 */
export const GetExchangeRatesRequest = proto3.makeMessageType(
 ...
 */
export const GetExchangeRatesResponse = proto3.makeMessageType(
 ...
 */
export const ConversionResponse = proto3.makeMessageType(
