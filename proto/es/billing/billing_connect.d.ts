...
export declare const BillingService: {
  ...
  readonly methods: {
    ...
    readonly sendInvoiceEmail: {
      readonly name: "SendInvoiceEmail",
      readonly I: typeof SendInvoiceEmailRequest,
      readonly O: typeof SendInvoiceEmailResponse,
      readonly kind: MethodKind.Unary,
    },
    /**
     ...
     */
    readonly ksefEnqueue: {
      readonly name: "KsefEnqueue",
      readonly I: typeof KsefEnqueueRequest,
      readonly O: typeof KsefEnqueueResponse,
      readonly kind: MethodKind.Unary,
    },
  }
};
...
export declare const CurrencyService: {
  ...
  readonly methods: {
    ...
    readonly convertMany: {
      readonly name: "ConvertMany",
      readonly I: typeof MultiConversionRequest,
      readonly O: typeof MultiConversionResponse,
      readonly kind: MethodKind.Unary,
    },
    /**
