...
export const BillingService = {
  ...
  methods: {
     ...
     */
    changeInvoiceNumber: {
      name: "ChangeInvoiceNumber",
      I: ChangeInvoiceNumberRequest,
      O: Invoice,
      kind: MethodKind.Unary,
    },
    /**
    ...
    createRenewalInvoice: {
      name: "CreateRenewalInvoice",
      I: CreateRenewalInvoiceRequest,
      O: Invoice,
      kind: MethodKind.Unary,
    },
    /**
    ...
    payWithBalance: {
      name: "PayWithBalance",
      I: PayWithBalanceRequest,
      O: PayWithBalanceResponse,
      kind: MethodKind.Unary,
    },
    /**
     * @generated from rpc nocloud.billing.BillingService.SendInvoiceEmail
     */
    sendInvoiceEmail: {
      name: "SendInvoiceEmail",
      I: SendInvoiceEmailRequest,
      O: SendInvoiceEmailResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     */
    runDailyCronJob: {
      name: "RunDailyCronJob",
      I: RunDailyCronJobRequest,
...
export const CurrencyService = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc nocloud.billing.CurrencyService.ConvertMany
     */
    convertMany: {
      name: "ConvertMany",
      I: MultiConversionRequest,
      O: MultiConversionResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    changeDefaultCurrency: {
      ...
      I: ChangeDefaultCurrencyRequest,
      O: ChangeDefaultCurrencyResponse,
      kind: MethodKind.Unary,
    },
  }
};
...
export const PromocodesService = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc nocloud.billing.PromocodesService.ApplySale
     */
    applySale: {
      name: "ApplySale",
      I: ApplySaleRequest,
