...
export declare class CreateInvoiceRequest extends Message<CreateInvoiceRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "nocloud.billing.CreateInvoiceRequest";
  static readonly fields: FieldList;
 ...
 */
export declare class GetInvoiceSettingsTemplateExampleRequest extends Message<GetInvoiceSettingsTemplateExampleRequest> {
  /**
  ...
  constructor(data?: PartialMessage<GetInvoiceSettingsTemplateExampleRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "nocloud.billing.GetInvoiceSettingsTemplateExampleRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetInvoiceSettingsTemplateExampleRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetInvoiceSettingsTemplateExampleRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetInvoiceSettingsTemplateExampleRequest;

  static equals(a: GetInvoiceSettingsTemplateExampleRequest | PlainMessage<GetInvoiceSettingsTemplateExampleRequest> | undefined, b: GetInvoiceSettingsTemplateExampleRequest | PlainMessage<GetInvoiceSettingsTemplateExampleRequest> | undefined): boolean;
}

/**
 * @generated from message nocloud.billing.GetInvoiceSettingsTemplateExampleResponse
 */
export declare class GetInvoiceSettingsTemplateExampleResponse extends Message<GetInvoiceSettingsTemplateExampleResponse> {
  /**
  ...
  constructor(data?: PartialMessage<GetInvoiceSettingsTemplateExampleResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "nocloud.billing.GetInvoiceSettingsTemplateExampleResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetInvoiceSettingsTemplateExampleResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetInvoiceSettingsTemplateExampleResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetInvoiceSettingsTemplateExampleResponse;

  static equals(a: GetInvoiceSettingsTemplateExampleResponse | PlainMessage<GetInvoiceSettingsTemplateExampleResponse> | undefined, b: GetInvoiceSettingsTemplateExampleResponse | PlainMessage<GetInvoiceSettingsTemplateExampleResponse> | undefined): boolean;
}
