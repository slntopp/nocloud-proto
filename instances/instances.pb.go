...
func (x *ChangeOwnershipRequest) Reset() {
	*x = ChangeOwnershipRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeOwnershipRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeOwnershipRequest) ProtoMessage() {}

func (x *ChangeOwnershipRequest) ProtoReflect() protoreflect.Message {
	mi := &file_instances_instances_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeOwnershipRequest.ProtoReflect.Descriptor instead.
func (*ChangeOwnershipRequest) Descriptor() ([]byte, []int) {
	return file_instances_instances_proto_rawDescGZIP(), []int{9}
}

func (x *ChangeOwnershipRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *ChangeOwnershipRequest) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *ChangeOwnershipResponse) Reset() {
	*x = ChangeOwnershipResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeOwnershipResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeOwnershipResponse) ProtoMessage() {}

func (x *ChangeOwnershipResponse) ProtoReflect() protoreflect.Message {
	mi := &file_instances_instances_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeOwnershipResponse.ProtoReflect.Descriptor instead.
func (*ChangeOwnershipResponse) Descriptor() ([]byte, []int) {
	return file_instances_instances_proto_rawDescGZIP(), []int{10}
}

func (x *ChangeOwnershipResponse) GetResult() bool {
	if x != nil {
		return x.Result
	}
	return false
...
func (x *ChangeOwnershipResponse) GetMeta() map[string]*structpb.Value {
	if x != nil {
		return x.Meta
	}
	return nil
...
var file_instances_instances_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0x40, 0x0a, 0x16, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4f, 0x77, 0x6e, 0x65,
	...
	0x75, 0x73, 0x65, 0x72, 0x22, 0xcc, 0x01, 0x0a, 0x17, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4f,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x48, 0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x6e, 0x6f, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	0x53, 0x10, 0x06, 0x32, 0xf3, 0x02, 0x0a, 0x10, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	...
	0x7b, 0x75, 0x75, 0x69, 0x64, 0x7d, 0x12, 0x80, 0x01, 0x0a, 0x0f, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x12, 0x29, 0x2e, 0x6e, 0x6f, 0x63,
	0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2e, 0x43,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x6e, 0x6f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x67, 0x73, 0x2f, 0x7b, 0x75, 0x75, 0x69, 0x64, 0x7d, 0x42, 0xb8, 0x01, 0x0a, 0x15, 0x63, 0x6f,
...
var file_instances_instances_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_instances_instances_proto_goTypes = []interface{}{
	...
	(*ChangeOwnershipRequest)(nil),           // 10: nocloud.instances.ChangeOwnershipRequest
	(*ChangeOwnershipResponse)(nil),          // 11: nocloud.instances.ChangeOwnershipResponse
	(*ObjectData)(nil),                       // 12: nocloud.instances.ObjectData
	nil,                                      // 13: nocloud.instances.Instance.ConfigEntry
	nil,                                      // 14: nocloud.instances.Instance.ResourcesEntry
	nil,                                      // 15: nocloud.instances.Instance.DataEntry
	nil,                                      // 16: nocloud.instances.InstancesGroup.ConfigEntry
	nil,                                      // 17: nocloud.instances.InstancesGroup.ResourcesEntry
	nil,                                      // 18: nocloud.instances.InstancesGroup.DataEntry
	nil,                                      // 19: nocloud.instances.InvokeRequest.ParamsEntry
	nil,                                      // 20: nocloud.instances.InvokeResponse.MetaEntry
	nil,                                      // 21: nocloud.instances.DeleteResponse.MetaEntry
	nil,                                      // 22: nocloud.instances.ChangeOwnershipResponse.MetaEntry
	nil,                                      // 23: nocloud.instances.ObjectData.DataEntry
	(*states.State)(nil),                     // 24: nocloud.states.State
	(*billing.Plan)(nil),                     // 25: nocloud.billing.Plan
	(*access.Access)(nil),                    // 26: nocloud.access.Access
	(*services_providers.ServicesProvider)(nil), // 27: nocloud.services_providers.ServicesProvider
...
var file_instances_instances_proto_depIdxs = []int32{
	...
	13, // 1: nocloud.instances.Instance.config:type_name -> nocloud.instances.Instance.ConfigEntry
	14, // 2: nocloud.instances.Instance.resources:type_name -> nocloud.instances.Instance.ResourcesEntry
	15, // 3: nocloud.instances.Instance.data:type_name -> nocloud.instances.Instance.DataEntry
	24, // 4: nocloud.instances.Instance.state:type_name -> nocloud.states.State
	25, // 5: nocloud.instances.Instance.billing_plan:type_name -> nocloud.billing.Plan
	26, // 6: nocloud.instances.Instance.access:type_name -> nocloud.access.Access
	0,  // 7: nocloud.instances.InstancesGroup.status:type_name -> nocloud.instances.InstanceStatus
	16, // 8: nocloud.instances.InstancesGroup.config:type_name -> nocloud.instances.InstancesGroup.ConfigEntry
	1,  // 9: nocloud.instances.InstancesGroup.instances:type_name -> nocloud.instances.Instance
	17, // 10: nocloud.instances.InstancesGroup.resources:type_name -> nocloud.instances.InstancesGroup.ResourcesEntry
	18, // 11: nocloud.instances.InstancesGroup.data:type_name -> nocloud.instances.InstancesGroup.DataEntry
	26, // 12: nocloud.instances.InstancesGroup.access:type_name -> nocloud.access.Access
	2,  // 13: nocloud.instances.TestInstancesGroupConfigRequest.group:type_name -> nocloud.instances.InstancesGroup
	27, // 14: nocloud.instances.TestInstancesGroupConfigRequest.sp:type_name -> nocloud.services_providers.ServicesProvider
	4,  // 15: nocloud.instances.TestInstancesGroupConfigResponse.errors:type_name -> nocloud.instances.TestInstancesGroupConfigError
	19, // 16: nocloud.instances.InvokeRequest.params:type_name -> nocloud.instances.InvokeRequest.ParamsEntry
	20, // 17: nocloud.instances.InvokeResponse.meta:type_name -> nocloud.instances.InvokeResponse.MetaEntry
	21, // 18: nocloud.instances.DeleteResponse.meta:type_name -> nocloud.instances.DeleteResponse.MetaEntry
	22, // 19: nocloud.instances.ChangeOwnershipResponse.meta:type_name -> nocloud.instances.ChangeOwnershipResponse.MetaEntry
	23, // 20: nocloud.instances.ObjectData.data:type_name -> nocloud.instances.ObjectData.DataEntry
	28, // 21: nocloud.instances.Instance.ConfigEntry.value:type_name -> google.protobuf.Value
	28, // 22: nocloud.instances.Instance.ResourcesEntry.value:type_name -> google.protobuf.Value
	28, // 23: nocloud.instances.Instance.DataEntry.value:type_name -> google.protobuf.Value
	28, // 24: nocloud.instances.InstancesGroup.ConfigEntry.value:type_name -> google.protobuf.Value
	28, // 25: nocloud.instances.InstancesGroup.ResourcesEntry.value:type_name -> google.protobuf.Value
	28, // 26: nocloud.instances.InstancesGroup.DataEntry.value:type_name -> google.protobuf.Value
	28, // 27: nocloud.instances.InvokeRequest.ParamsEntry.value:type_name -> google.protobuf.Value
	28, // 28: nocloud.instances.InvokeResponse.MetaEntry.value:type_name -> google.protobuf.Value
	28, // 29: nocloud.instances.DeleteResponse.MetaEntry.value:type_name -> google.protobuf.Value
	28, // 30: nocloud.instances.ChangeOwnershipResponse.MetaEntry.value:type_name -> google.protobuf.Value
	28, // 31: nocloud.instances.ObjectData.DataEntry.value:type_name -> google.protobuf.Value
	6,  // 32: nocloud.instances.InstancesService.Invoke:input_type -> nocloud.instances.InvokeRequest
	8,  // 33: nocloud.instances.InstancesService.Delete:input_type -> nocloud.instances.DeleteRequest
	10, // 34: nocloud.instances.InstancesService.ChangeOwnership:input_type -> nocloud.instances.ChangeOwnershipRequest
	7,  // 35: nocloud.instances.InstancesService.Invoke:output_type -> nocloud.instances.InvokeResponse
	9,  // 36: nocloud.instances.InstancesService.Delete:output_type -> nocloud.instances.DeleteResponse
	11, // 37: nocloud.instances.InstancesService.ChangeOwnership:output_type -> nocloud.instances.ChangeOwnershipResponse
...
func file_instances_instances_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_instances_instances_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeOwnershipRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_instances_instances_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeOwnershipResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
