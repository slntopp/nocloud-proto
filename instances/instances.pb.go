...
var file_instances_instances_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x96, 0x08, 0x0a, 0x10, 0x49,
	...
	0x75, 0x69, 0x64, 0x7d, 0x12, 0x71, 0x0a, 0x0a, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
...
var file_instances_instances_proto_goTypes = []interface{}{
	...
	(*services_providers.ServicesProvider)(nil), // 34: nocloud.services_providers.ServicesProvider
	(*billing.CostEstimation)(nil),              // 35: nocloud.billing.CostEstimation
	(*structpb.Value)(nil),                      // 36: google.protobuf.Value
	(*notes.AddNoteRequest)(nil),                // 37: nocloud.notes.AddNoteRequest
	(*notes.PatchNoteRequest)(nil),              // 38: nocloud.notes.PatchNoteRequest
	(*notes.RemoveNoteRequest)(nil),             // 39: nocloud.notes.RemoveNoteRequest
	(*notes.NoteResponse)(nil),                  // 40: nocloud.notes.NoteResponse
}
var file_instances_instances_proto_depIdxs = []int32{
	...
	33, // 8: nocloud.instances.Instance.admin_notes:type_name -> nocloud.notes.AdminNote
	28, // 9: nocloud.instances.InstancesGroup.status:type_name -> nocloud.statuses.NoCloudStatus
	18, // 10: nocloud.instances.InstancesGroup.config:type_name -> nocloud.instances.InstancesGroup.ConfigEntry
	0,  // 11: nocloud.instances.InstancesGroup.instances:type_name -> nocloud.instances.Instance
	19, // 12: nocloud.instances.InstancesGroup.resources:type_name -> nocloud.instances.InstancesGroup.ResourcesEntry
	20, // 13: nocloud.instances.InstancesGroup.data:type_name -> nocloud.instances.InstancesGroup.DataEntry
	31, // 14: nocloud.instances.InstancesGroup.access:type_name -> nocloud.access.Access
	1,  // 15: nocloud.instances.TestInstancesGroupConfigRequest.group:type_name -> nocloud.instances.InstancesGroup
	34, // 16: nocloud.instances.TestInstancesGroupConfigRequest.sp:type_name -> nocloud.services_providers.ServicesProvider
	35, // 17: nocloud.instances.InstanceCostEstimation.down_payment:type_name -> nocloud.billing.CostEstimation
	35, // 18: nocloud.instances.InstanceCostEstimation.general:type_name -> nocloud.billing.CostEstimation
	3,  // 19: nocloud.instances.TestInstancesGroupConfigResponse.errors:type_name -> nocloud.instances.TestInstancesGroupConfigError
	21, // 20: nocloud.instances.TestInstancesGroupConfigResponse.estimations:type_name -> nocloud.instances.TestInstancesGroupConfigResponse.EstimationsEntry
	22, // 21: nocloud.instances.InvokeRequest.params:type_name -> nocloud.instances.InvokeRequest.ParamsEntry
	23, // 22: nocloud.instances.InvokeResponse.meta:type_name -> nocloud.instances.InvokeResponse.MetaEntry
	24, // 23: nocloud.instances.DeleteResponse.meta:type_name -> nocloud.instances.DeleteResponse.MetaEntry
	25, // 24: nocloud.instances.TransferIGResponse.meta:type_name -> nocloud.instances.TransferIGResponse.MetaEntry
	26, // 25: nocloud.instances.TransferInstanceResponse.meta:type_name -> nocloud.instances.TransferInstanceResponse.MetaEntry
	27, // 26: nocloud.instances.ObjectData.data:type_name -> nocloud.instances.ObjectData.DataEntry
	36, // 27: nocloud.instances.Instance.ConfigEntry.value:type_name -> google.protobuf.Value
	36, // 28: nocloud.instances.Instance.ResourcesEntry.value:type_name -> google.protobuf.Value
	36, // 29: nocloud.instances.Instance.DataEntry.value:type_name -> google.protobuf.Value
	36, // 30: nocloud.instances.InstancesGroup.ConfigEntry.value:type_name -> google.protobuf.Value
	36, // 31: nocloud.instances.InstancesGroup.ResourcesEntry.value:type_name -> google.protobuf.Value
	36, // 32: nocloud.instances.InstancesGroup.DataEntry.value:type_name -> google.protobuf.Value
	4,  // 33: nocloud.instances.TestInstancesGroupConfigResponse.EstimationsEntry.value:type_name -> nocloud.instances.InstanceCostEstimation
	36, // 34: nocloud.instances.InvokeRequest.ParamsEntry.value:type_name -> google.protobuf.Value
	36, // 35: nocloud.instances.InvokeResponse.MetaEntry.value:type_name -> google.protobuf.Value
	36, // 36: nocloud.instances.DeleteResponse.MetaEntry.value:type_name -> google.protobuf.Value
	36, // 37: nocloud.instances.TransferIGResponse.MetaEntry.value:type_name -> google.protobuf.Value
	36, // 38: nocloud.instances.TransferInstanceResponse.MetaEntry.value:type_name -> google.protobuf.Value
	36, // 39: nocloud.instances.ObjectData.DataEntry.value:type_name -> google.protobuf.Value
	6,  // 40: nocloud.instances.InstancesService.Invoke:input_type -> nocloud.instances.InvokeRequest
	8,  // 41: nocloud.instances.InstancesService.Delete:input_type -> nocloud.instances.DeleteRequest
	37, // 42: nocloud.instances.InstancesService.AddNote:input_type -> nocloud.notes.AddNoteRequest
	38, // 43: nocloud.instances.InstancesService.PatchNote:input_type -> nocloud.notes.PatchNoteRequest
	39, // 44: nocloud.instances.InstancesService.RemoveNote:input_type -> nocloud.notes.RemoveNoteRequest
	8,  // 45: nocloud.instances.InstancesService.Detach:input_type -> nocloud.instances.DeleteRequest
	8,  // 46: nocloud.instances.InstancesService.Attach:input_type -> nocloud.instances.DeleteRequest
	10, // 47: nocloud.instances.InstancesService.TransferIG:input_type -> nocloud.instances.TransferIGRequest
	12, // 48: nocloud.instances.InstancesService.TransferInstance:input_type -> nocloud.instances.TransferInstanceRequest
	7,  // 49: nocloud.instances.InstancesService.Invoke:output_type -> nocloud.instances.InvokeResponse
	9,  // 50: nocloud.instances.InstancesService.Delete:output_type -> nocloud.instances.DeleteResponse
	40, // 51: nocloud.instances.InstancesService.AddNote:output_type -> nocloud.notes.NoteResponse
	40, // 52: nocloud.instances.InstancesService.PatchNote:output_type -> nocloud.notes.NoteResponse
	40, // 53: nocloud.instances.InstancesService.RemoveNote:output_type -> nocloud.notes.NoteResponse
	9,  // 54: nocloud.instances.InstancesService.Detach:output_type -> nocloud.instances.DeleteResponse
	9,  // 55: nocloud.instances.InstancesService.Attach:output_type -> nocloud.instances.DeleteResponse
	11, // 56: nocloud.instances.InstancesService.TransferIG:output_type -> nocloud.instances.TransferIGResponse
	13, // 57: nocloud.instances.InstancesService.TransferInstance:output_type -> nocloud.instances.TransferInstanceResponse
