...
func (c *instancesServiceClient) Get(ctx context.Context, in *Instance, opts ...grpc.CallOption) (*ResponseInstance, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseInstance)
...
func (UnimplementedInstancesServiceServer) GetUnique(context.Context, *GetUniqueRequest) (*GetUniqueResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUnique not implemented")
}
func (UnimplementedInstancesServiceServer) TransferIG(context.Context, *TransferIGRequest) (*TransferIGResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferIG not implemented")
}
func (UnimplementedInstancesServiceServer) TransferInstance(context.Context, *TransferInstanceRequest) (*TransferInstanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferInstance not implemented")
}
...
func RegisterInstancesServiceServer(s grpc.ServiceRegistrar, srv InstancesServiceServer) {
	// If the following call panics, it indicates UnimplementedInstancesServiceServer was
