...
// UnimplementedEventsLoggingServiceServer must be embedded to have
...
func (UnimplementedEventsLoggingServiceServer) testEmbeddedByValue()                              {}
...
func RegisterEventsLoggingServiceServer(s grpc.ServiceRegistrar, srv EventsLoggingServiceServer) {
	// If the following call pancis, it indicates UnimplementedEventsLoggingServiceServer was
