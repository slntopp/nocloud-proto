...
type ServicesServiceClient interface {
	...
	Stream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[states.ObjectState], error)
}
...
func (c *servicesServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Service, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Service)
	err := c.cc.Invoke(ctx, ServicesService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesServiceClient) Up(ctx context.Context, in *UpRequest, opts ...grpc.CallOption) (*UpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpResponse)
	err := c.cc.Invoke(ctx, ServicesService_Up_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesServiceClient) Down(ctx context.Context, in *DownRequest, opts ...grpc.CallOption) (*DownResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServicesService_Down_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesServiceClient) Suspend(ctx context.Context, in *SuspendRequest, opts ...grpc.CallOption) (*SuspendResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServicesService_Suspend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesServiceClient) Unsuspend(ctx context.Context, in *UnsuspendRequest, opts ...grpc.CallOption) (*UnsuspendResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServicesService_Unsuspend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesServiceClient) Stream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[states.ObjectState], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ServicesService_ServiceDesc.Streams[0], ServicesService_Stream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamRequest, states.ObjectState]{ClientStream: stream}
...
type ServicesService_StreamClient = grpc.ServerStreamingClient[states.ObjectState]
...
type ServicesServiceServer interface {
	...
	Stream(*StreamRequest, grpc.ServerStreamingServer[states.ObjectState]) error
...
func (UnimplementedServicesServiceServer) Stream(*StreamRequest, grpc.ServerStreamingServer[states.ObjectState]) error {
...
func _ServicesService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ServicesServiceServer).Stream(m, &grpc.GenericServerStream[StreamRequest, states.ObjectState]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ServicesService_StreamServer = grpc.ServerStreamingServer[states.ObjectState]
