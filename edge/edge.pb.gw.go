...
func request_EdgeService_PostConfigData_0(ctx context.Context, marshaler runtime.Marshaler, client EdgeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.PostConfigData(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_EdgeService_PostConfigData_0(ctx context.Context, marshaler runtime.Marshaler, server EdgeServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ConfigData
	var metadata runtime.ServerMetadata
	...
	msg, err := server.PostConfigData(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterEdgeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EdgeServiceServer) error {
	...
	mux.Handle("POST", pattern_EdgeService_PostConfigData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/nocloud.edge.EdgeService/PostConfigData", runtime.WithHTTPPathPattern("/edge/post_config_data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EdgeService_PostConfigData_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_EdgeService_PostConfigData_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEdgeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EdgeServiceClient) error {
	...
	mux.Handle("POST", pattern_EdgeService_PostConfigData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/nocloud.edge.EdgeService/PostConfigData", runtime.WithHTTPPathPattern("/edge/post_config_data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EdgeService_PostConfigData_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_EdgeService_PostConfigData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"edge", "post_config_data"}, ""))
)

var (
	forward_EdgeService_PostState_0 = runtime.ForwardResponseMessage

	forward_EdgeService_PostConfigData_0 = runtime.ForwardResponseMessage
)
