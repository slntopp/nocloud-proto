...
func RegisterRecordsServiceServer(s grpc.ServiceRegistrar, srv RecordsServiceServer) {
	// If the following call panics, it indicates UnimplementedRecordsServiceServer was
...
func (UnimplementedBillingServiceServer) ListPlansInstances(context.Context, *ListPlansInstancesRequest) (*ListPlansInstancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPlansInstances not implemented")
}
func (UnimplementedBillingServiceServer) PlansUnique(context.Context, *PlansUniqueRequest) (*PlansUniqueResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PlansUnique not implemented")
}
...
func (UnimplementedBillingServiceServer) GetTransactionsCount(context.Context, *GetTransactionsCountRequest) (*GetTransactionsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionsCount not implemented")
}
...
func (UnimplementedBillingServiceServer) GetInstancesReports(context.Context, *GetInstancesReportRequest) (*GetInstancesReportResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInstancesReports not implemented")
}
func (UnimplementedBillingServiceServer) GetInstancesReportsCount(context.Context, *GetInstancesReportsCountRequest) (*GetReportsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInstancesReportsCount not implemented")
}
func (UnimplementedBillingServiceServer) GetRecordsReports(context.Context, *GetRecordsReportsRequest) (*GetRecordsReportsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecordsReports not implemented")
}
func (UnimplementedBillingServiceServer) GetRecordsReportsCount(context.Context, *GetRecordsReportsCountRequest) (*GetReportsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecordsReportsCount not implemented")
}
...
func (UnimplementedBillingServiceServer) GetInvoicesCount(context.Context, *GetInvoicesCountRequest) (*GetInvoicesCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInvoicesCount not implemented")
}
...
func (UnimplementedBillingServiceServer) ChangeInvoiceNumber(context.Context, *ChangeInvoiceNumberRequest) (*Invoice, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeInvoiceNumber not implemented")
}
...
func (UnimplementedBillingServiceServer) CreateTopUpBalanceInvoice(context.Context, *CreateTopUpBalanceInvoiceRequest) (*Invoice, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTopUpBalanceInvoice not implemented")
}
func (UnimplementedBillingServiceServer) CreateRenewalInvoice(context.Context, *CreateRenewalInvoiceRequest) (*Invoice, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateRenewalInvoice not implemented")
}
func (UnimplementedBillingServiceServer) PayWithBalance(context.Context, *PayWithBalanceRequest) (*PayWithBalanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PayWithBalance not implemented")
}
func (UnimplementedBillingServiceServer) SendInvoiceEmail(context.Context, *SendInvoiceEmailRequest) (*SendInvoiceEmailResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendInvoiceEmail not implemented")
}
func (UnimplementedBillingServiceServer) GetInvoiceSettingsTemplateExample(context.Context, *GetInvoiceSettingsTemplateExampleRequest) (*GetInvoiceSettingsTemplateExampleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInvoiceSettingsTemplateExample not implemented")
}
func (UnimplementedBillingServiceServer) RunDailyCronJob(context.Context, *RunDailyCronJobRequest) (*RunDailyCronJobResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RunDailyCronJob not implemented")
}
...
func (UnimplementedCurrencyServiceServer) ConvertMany(context.Context, *MultiConversionRequest) (*MultiConversionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertMany not implemented")
}
func (UnimplementedCurrencyServiceServer) ChangeDefaultCurrency(context.Context, *ChangeDefaultCurrencyRequest) (*ChangeDefaultCurrencyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeDefaultCurrency not implemented")
}
...
func RegisterAddonsServiceServer(s grpc.ServiceRegistrar, srv AddonsServiceServer) {
	// If the following call panics, it indicates UnimplementedAddonsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterDescriptionsServiceServer(s grpc.ServiceRegistrar, srv DescriptionsServiceServer) {
	// If the following call panics, it indicates UnimplementedDescriptionsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (c *promocodesServiceClient) ApplySale(ctx context.Context, in *ApplySaleRequest, opts ...grpc.CallOption) (*ApplySaleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApplySaleResponse)
	err := c.cc.Invoke(ctx, PromocodesService_ApplySale_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPromocodesServiceServer) ApplySale(context.Context, *ApplySaleRequest) (*ApplySaleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplySale not implemented")
}
...
func RegisterPromocodesServiceServer(s grpc.ServiceRegistrar, srv PromocodesServiceServer) {
	// If the following call panics, it indicates UnimplementedPromocodesServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _PromocodesService_ApplySale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplySaleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PromocodesServiceServer).ApplySale(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PromocodesService_ApplySale_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PromocodesServiceServer).ApplySale(ctx, req.(*ApplySaleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
