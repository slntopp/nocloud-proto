...
const (
	...
	// BillingServiceSendInvoiceEmailProcedure is the fully-qualified name of the BillingService's
	// SendInvoiceEmail RPC.
	BillingServiceSendInvoiceEmailProcedure = "/nocloud.billing.BillingService/SendInvoiceEmail"
...
type BillingServiceClient interface {
	...
	SendInvoiceEmail(context.Context, *connect.Request[billing.SendInvoiceEmailRequest]) (*connect.Response[billing.SendInvoiceEmailResponse], error)
...
func NewBillingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BillingServiceClient {
	...
	return &billingServiceClient{
		...
		changeInvoiceNumber: connect.NewClient[billing.ChangeInvoiceNumberRequest, billing.Invoice](
			...
			connect.WithSchema(billingServiceMethods.ByName("ChangeInvoiceNumber")),
			connect.WithClientOptions(opts...),
		),
...
type billingServiceClient struct {
	...
	sendInvoiceEmail                  *connect.Client[billing.SendInvoiceEmailRequest, billing.SendInvoiceEmailResponse]
...
// SendInvoiceEmail calls nocloud.billing.BillingService.SendInvoiceEmail.
func (c *billingServiceClient) SendInvoiceEmail(ctx context.Context, req *connect.Request[billing.SendInvoiceEmailRequest]) (*connect.Response[billing.SendInvoiceEmailResponse], error) {
	return c.sendInvoiceEmail.CallUnary(ctx, req)
}
...
func NewBillingServiceHandler(svc BillingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nocloud.billing.BillingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case BillingServiceSendInvoiceEmailProcedure:
			billingServiceSendInvoiceEmailHandler.ServeHTTP(w, r)
...
func (UnimplementedBillingServiceHandler) SendInvoiceEmail(context.Context, *connect.Request[billing.SendInvoiceEmailRequest]) (*connect.Response[billing.SendInvoiceEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nocloud.billing.BillingService.SendInvoiceEmail is not implemented"))
}
