...
var file_billing_billing_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x89, 0x01, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x74, 0x65, 0x22, 0x1c, 0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x78, 0x63, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x89, 0x01, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x78, 0x63, 0x68, 0x61,
	...
	0x20, 0x03, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6e, 0x6f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x62,
	...
	0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x87, 0x01, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	0x72, 0x61, 0x74, 0x65, 0x22, 0x5a, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x45, 0x78, 0x63, 0x68, 0x61,
	...
	0x4c, 0x10, 0x02, 0x2a, 0x37, 0x0a, 0x08, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12,
	0x07, 0x0a, 0x03, 0x4e, 0x43, 0x55, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x55, 0x53, 0x44, 0x10,
	0x01, 0x12, 0x07, 0x0a, 0x03, 0x45, 0x55, 0x52, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x42, 0x59,
	0x4e, 0x10, 0x03, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4c, 0x4e, 0x10, 0x04, 0x32, 0xd6, 0x01, 0x0a,
	...
	0x63, 0x6f, 0x72, 0x64, 0x73, 0x32, 0xf3, 0x0a, 0x0a, 0x0e, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e,
...
var file_billing_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_billing_billing_proto_goTypes = []interface{}{
	...
	(*CreateExchangeRateRequest)(nil),    // 26: nocloud.billing.CreateExchangeRateRequest
	(*CreateExchangeRateResponse)(nil),   // 27: nocloud.billing.CreateExchangeRateResponse
	(*UpdateExchangeRateRequest)(nil),    // 28: nocloud.billing.UpdateExchangeRateRequest
	(*UpdateExchangeRateResponse)(nil),   // 29: nocloud.billing.UpdateExchangeRateResponse
	(*DeleteExchangeRateRequest)(nil),    // 30: nocloud.billing.DeleteExchangeRateRequest
	(*DeleteExchangeRateResponse)(nil),   // 31: nocloud.billing.DeleteExchangeRateResponse
	(*GetCurrenciesRequest)(nil),         // 32: nocloud.billing.GetCurrenciesRequest
	(*GetCurrenciesResponse)(nil),        // 33: nocloud.billing.GetCurrenciesResponse
	(*GetExchangeRateRequest)(nil),       // 34: nocloud.billing.GetExchangeRateRequest
	(*GetExchangeRatesRequest)(nil),      // 35: nocloud.billing.GetExchangeRatesRequest
	(*GetExchangeRateResponse)(nil),      // 36: nocloud.billing.GetExchangeRateResponse
	(*GetExchangeRatesResponse)(nil),     // 37: nocloud.billing.GetExchangeRatesResponse
	(*ConversionRequest)(nil),            // 38: nocloud.billing.ConversionRequest
	(*ConversionResponse)(nil),           // 39: nocloud.billing.ConversionResponse
	nil,                                  // 40: nocloud.billing.Plan.ProductsEntry
	nil,                                  // 41: nocloud.billing.Plan.MetaEntry
	nil,                                  // 42: nocloud.billing.ListPlansInstancesResponse.PlansEntry
	nil,                                  // 43: nocloud.billing.Product.ResourcesEntry
	nil,                                  // 44: nocloud.billing.Product.MetaEntry
	nil,                                  // 45: nocloud.billing.Transaction.MetaEntry
	nil,                                  // 46: nocloud.billing.Record.MetaEntry
	nil,                                  // 47: nocloud.billing.CostEstimation.ResourcesEntry
	(*ansible.Software)(nil),             // 48: nocloud.ansible.Software
	(states.NoCloudState)(0),             // 49: nocloud.states.NoCloudState
...
var file_billing_billing_proto_depIdxs = []int32{
	...
	40, // 4: nocloud.billing.Plan.products:type_name -> nocloud.billing.Plan.ProductsEntry
	41, // 5: nocloud.billing.Plan.meta:type_name -> nocloud.billing.Plan.MetaEntry
	6,  // 6: nocloud.billing.Plan.fee:type_name -> nocloud.billing.Fee
	48, // 7: nocloud.billing.Plan.software:type_name -> nocloud.ansible.Software
	7,  // 8: nocloud.billing.ListResponse.pool:type_name -> nocloud.billing.Plan
	42, // 9: nocloud.billing.ListPlansInstancesResponse.plans:type_name -> nocloud.billing.ListPlansInstancesResponse.PlansEntry
	2,  // 10: nocloud.billing.ResourceConf.kind:type_name -> nocloud.billing.Kind
	49, // 11: nocloud.billing.ResourceConf.on:type_name -> nocloud.states.NoCloudState
	...
	43, // 14: nocloud.billing.Product.resources:type_name -> nocloud.billing.Product.ResourcesEntry
	44, // 15: nocloud.billing.Product.meta:type_name -> nocloud.billing.Product.MetaEntry
	3,  // 16: nocloud.billing.Transaction.priority:type_name -> nocloud.billing.Priority
	45, // 17: nocloud.billing.Transaction.meta:type_name -> nocloud.billing.Transaction.MetaEntry
	...
	49, // 21: nocloud.billing.Record.state:type_name -> nocloud.states.NoCloudState
	46, // 22: nocloud.billing.Record.meta:type_name -> nocloud.billing.Record.MetaEntry
	...
	47, // 25: nocloud.billing.CostEstimation.resources:type_name -> nocloud.billing.CostEstimation.ResourcesEntry
	4,  // 26: nocloud.billing.CreateExchangeRateRequest.from:type_name -> nocloud.billing.Currency
	4,  // 27: nocloud.billing.CreateExchangeRateRequest.to:type_name -> nocloud.billing.Currency
	4,  // 28: nocloud.billing.UpdateExchangeRateRequest.from:type_name -> nocloud.billing.Currency
	4,  // 29: nocloud.billing.UpdateExchangeRateRequest.to:type_name -> nocloud.billing.Currency
	4,  // 30: nocloud.billing.DeleteExchangeRateRequest.from:type_name -> nocloud.billing.Currency
	4,  // 31: nocloud.billing.DeleteExchangeRateRequest.to:type_name -> nocloud.billing.Currency
	4,  // 32: nocloud.billing.GetCurrenciesResponse.currencies:type_name -> nocloud.billing.Currency
	4,  // 33: nocloud.billing.GetExchangeRateRequest.from:type_name -> nocloud.billing.Currency
	4,  // 34: nocloud.billing.GetExchangeRateRequest.to:type_name -> nocloud.billing.Currency
	4,  // 35: nocloud.billing.GetExchangeRateResponse.from:type_name -> nocloud.billing.Currency
	4,  // 36: nocloud.billing.GetExchangeRateResponse.to:type_name -> nocloud.billing.Currency
	36, // 37: nocloud.billing.GetExchangeRatesResponse.rates:type_name -> nocloud.billing.GetExchangeRateResponse
	4,  // 38: nocloud.billing.ConversionRequest.from:type_name -> nocloud.billing.Currency
	4,  // 39: nocloud.billing.ConversionRequest.to:type_name -> nocloud.billing.Currency
	13, // 40: nocloud.billing.Plan.ProductsEntry.value:type_name -> nocloud.billing.Product
	50, // 41: nocloud.billing.Plan.MetaEntry.value:type_name -> google.protobuf.Value
	50, // 42: nocloud.billing.ListPlansInstancesResponse.PlansEntry.value:type_name -> google.protobuf.Value
	50, // 43: nocloud.billing.Product.ResourcesEntry.value:type_name -> google.protobuf.Value
	50, // 44: nocloud.billing.Product.MetaEntry.value:type_name -> google.protobuf.Value
	50, // 45: nocloud.billing.Transaction.MetaEntry.value:type_name -> google.protobuf.Value
	50, // 46: nocloud.billing.Record.MetaEntry.value:type_name -> google.protobuf.Value
	18, // 47: nocloud.billing.RecordsService.GetActive:input_type -> nocloud.billing.GetActiveRequest
	17, // 48: nocloud.billing.RecordsService.Create:input_type -> nocloud.billing.Records
	17, // 49: nocloud.billing.RecordsService.Update:input_type -> nocloud.billing.Records
	7,  // 50: nocloud.billing.BillingService.CreatePlan:input_type -> nocloud.billing.Plan
	7,  // 51: nocloud.billing.BillingService.UpdatePlan:input_type -> nocloud.billing.Plan
	7,  // 52: nocloud.billing.BillingService.GetPlan:input_type -> nocloud.billing.Plan
	8,  // 53: nocloud.billing.BillingService.ListPlans:input_type -> nocloud.billing.ListRequest
	10, // 54: nocloud.billing.BillingService.ListPlansInstances:input_type -> nocloud.billing.ListPlansInstancesRequest
	7,  // 55: nocloud.billing.BillingService.DeletePlan:input_type -> nocloud.billing.Plan
	14, // 56: nocloud.billing.BillingService.CreateTransaction:input_type -> nocloud.billing.Transaction
	19, // 57: nocloud.billing.BillingService.GetTransactions:input_type -> nocloud.billing.GetTransactionsRequest
	21, // 58: nocloud.billing.BillingService.GetTransactionsCount:input_type -> nocloud.billing.GetTransactionsCountRequest
	14, // 59: nocloud.billing.BillingService.UpdateTransaction:input_type -> nocloud.billing.Transaction
	14, // 60: nocloud.billing.BillingService.GetRecords:input_type -> nocloud.billing.Transaction
	20, // 61: nocloud.billing.BillingService.Reprocess:input_type -> nocloud.billing.ReprocessTransactionsRequest
	32, // 62: nocloud.billing.CurrencyService.GetCurrencies:input_type -> nocloud.billing.GetCurrenciesRequest
	34, // 63: nocloud.billing.CurrencyService.GetExchangeRate:input_type -> nocloud.billing.GetExchangeRateRequest
	35, // 64: nocloud.billing.CurrencyService.GetExchangeRates:input_type -> nocloud.billing.GetExchangeRatesRequest
	26, // 65: nocloud.billing.CurrencyService.CreateExchangeRate:input_type -> nocloud.billing.CreateExchangeRateRequest
	28, // 66: nocloud.billing.CurrencyService.UpdateExchangeRate:input_type -> nocloud.billing.UpdateExchangeRateRequest
	30, // 67: nocloud.billing.CurrencyService.DeleteExchangeRate:input_type -> nocloud.billing.DeleteExchangeRateRequest
	38, // 68: nocloud.billing.CurrencyService.Convert:input_type -> nocloud.billing.ConversionRequest
	17, // 69: nocloud.billing.RecordsService.GetActive:output_type -> nocloud.billing.Records
	17, // 70: nocloud.billing.RecordsService.Create:output_type -> nocloud.billing.Records
	17, // 71: nocloud.billing.RecordsService.Update:output_type -> nocloud.billing.Records
	7,  // 72: nocloud.billing.BillingService.CreatePlan:output_type -> nocloud.billing.Plan
	7,  // 73: nocloud.billing.BillingService.UpdatePlan:output_type -> nocloud.billing.Plan
	7,  // 74: nocloud.billing.BillingService.GetPlan:output_type -> nocloud.billing.Plan
	9,  // 75: nocloud.billing.BillingService.ListPlans:output_type -> nocloud.billing.ListResponse
	11, // 76: nocloud.billing.BillingService.ListPlansInstances:output_type -> nocloud.billing.ListPlansInstancesResponse
	7,  // 77: nocloud.billing.BillingService.DeletePlan:output_type -> nocloud.billing.Plan
	14, // 78: nocloud.billing.BillingService.CreateTransaction:output_type -> nocloud.billing.Transaction
	15, // 79: nocloud.billing.BillingService.GetTransactions:output_type -> nocloud.billing.Transactions
	22, // 80: nocloud.billing.BillingService.GetTransactionsCount:output_type -> nocloud.billing.GetTransactionsCountResponse
	24, // 81: nocloud.billing.BillingService.UpdateTransaction:output_type -> nocloud.billing.UpdateTransactionResponse
	17, // 82: nocloud.billing.BillingService.GetRecords:output_type -> nocloud.billing.Records
	15, // 83: nocloud.billing.BillingService.Reprocess:output_type -> nocloud.billing.Transactions
	33, // 84: nocloud.billing.CurrencyService.GetCurrencies:output_type -> nocloud.billing.GetCurrenciesResponse
	36, // 85: nocloud.billing.CurrencyService.GetExchangeRate:output_type -> nocloud.billing.GetExchangeRateResponse
	37, // 86: nocloud.billing.CurrencyService.GetExchangeRates:output_type -> nocloud.billing.GetExchangeRatesResponse
	27, // 87: nocloud.billing.CurrencyService.CreateExchangeRate:output_type -> nocloud.billing.CreateExchangeRateResponse
	29, // 88: nocloud.billing.CurrencyService.UpdateExchangeRate:output_type -> nocloud.billing.UpdateExchangeRateResponse
	31, // 89: nocloud.billing.CurrencyService.DeleteExchangeRate:output_type -> nocloud.billing.DeleteExchangeRateResponse
	39, // 90: nocloud.billing.CurrencyService.Convert:output_type -> nocloud.billing.ConversionResponse
