...
const (
	...
	AccountsService_Logout_FullMethodName             = "/nocloud.registry.AccountsService/Logout"
...
type AccountsServiceClient interface {
	...
	Logout(ctx context.Context, in *accounts.LogoutRequest, opts ...grpc.CallOption) (*accounts.LogoutResponse, error)
...
func (c *accountsServiceClient) Logout(ctx context.Context, in *accounts.LogoutRequest, opts ...grpc.CallOption) (*accounts.LogoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(accounts.LogoutResponse)
...
func (c *accountsServiceClient) AddNote(ctx context.Context, in *notes.AddNoteRequest, opts ...grpc.CallOption) (*notes.NoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountsService_AddNote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsServiceClient) PatchNote(ctx context.Context, in *notes.PatchNoteRequest, opts ...grpc.CallOption) (*notes.NoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(notes.NoteResponse)
	err := c.cc.Invoke(ctx, AccountsService_PatchNote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsServiceClient) RemoveNote(ctx context.Context, in *notes.RemoveNoteRequest, opts ...grpc.CallOption) (*notes.NoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(notes.NoteResponse)
	err := c.cc.Invoke(ctx, AccountsService_RemoveNote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsServiceClient) Suspend(ctx context.Context, in *accounts.SuspendRequest, opts ...grpc.CallOption) (*accounts.SuspendResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountsService_Suspend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsServiceClient) Unsuspend(ctx context.Context, in *accounts.UnsuspendRequest, opts ...grpc.CallOption) (*accounts.UnsuspendResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountsService_Unsuspend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountsServiceServer interface {
	...
	Logout(context.Context, *accounts.LogoutRequest) (*accounts.LogoutResponse, error)
...
func (UnimplementedAccountsServiceServer) Logout(context.Context, *accounts.LogoutRequest) (*accounts.LogoutResponse, error) {
...
func (UnimplementedAccountsServiceServer) ChangeLanguageCode(context.Context, *accounts.ChangeLanguageCodeRequest) (*accounts.ChangeLanguageCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeLanguageCode not implemented")
}
...
func _AccountsService_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServiceServer).Logout(ctx, req.(*accounts.LogoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (c *namespacesServiceClient) Link(ctx context.Context, in *namespaces.LinkRequest, opts ...grpc.CallOption) (*namespaces.LinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, NamespacesService_Link_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *namespacesServiceClient) Patch(ctx context.Context, in *namespaces.PatchRequest, opts ...grpc.CallOption) (*namespaces.PatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, NamespacesService_Patch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterAccountGroupsServiceServer(s grpc.ServiceRegistrar, srv AccountGroupsServiceServer) {
	// If the following call panics, it indicates UnimplementedAccountGroupsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
