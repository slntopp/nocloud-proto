...
func RegisterServicesProvidersServiceServer(s grpc.ServiceRegistrar, srv ServicesProvidersServiceServer) {
	// If the following call panics, it indicates UnimplementedServicesProvidersServiceServer was
...
func RegisterServicesProvidersExtentionsServiceServer(s grpc.ServiceRegistrar, srv ServicesProvidersExtentionsServiceServer) {
	// If the following call panics, it indicates UnimplementedServicesProvidersExtentionsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterShowcasesServiceServer(s grpc.ServiceRegistrar, srv ShowcasesServiceServer) {
	// If the following call panics, it indicates UnimplementedShowcasesServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterShowcaseCategoriesServiceServer(s grpc.ServiceRegistrar, srv ShowcaseCategoriesServiceServer) {
	// If the following call panics, it indicates UnimplementedShowcaseCategoriesServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
